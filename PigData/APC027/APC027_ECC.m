...
% BDF zero: 0s (BDF) / 17170 (flip entry)
% Start time: 800s (BDF) / 25170 (flip entry)
% End time: 1000s (BDF) / 27170 (flip entry)

% Extract and save to matrix:
expB = CON_data_m(25170:27170,4:20); % 1-16: Dest, 17: Pressure
[nRows,~] = size(expB);
...
import2 = 1;
if import2 == 1
    addpath 'F:\PigData\APC027'
    toappSWdata = load('APC027_exp1_800-1000s_SW','toapp');
    toappSPKdata = load('APC027_exp1_800-1000s_SPK','toapp');
    excelCONdata = readmatrix('APC027_ContractionClusterList.xlsx');
    SW_AMPs = readmatrix('APC027_SW_AMP.xlsx');
...
g_clsts = 1:14;
i_clsts = [22:24;27:29;32:34;36:38;41:43;45:47;50:52;54:56;58:60;62:64;67:69;71:73;75:77;78:80];
