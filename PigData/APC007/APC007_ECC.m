...
% 1600 BDF = 10:48:07 FLIP = entry 36612
% 36612 - 10*600 = 30612 => BDF time = 1000 s
% 36612 - 10*1600 = 20612 => BDF time = 0 s
% At 10:20:20, a minute prior to BDF recording we have squeezes at the last
% 2 electrodes (duodenal).

Fs_flip = 10; % Sampling frequency (Hz)
% Extract and save to matrix:
exp2 = CON_data_m(30612:32612,4:20); % 1-16: Dest, 17: Pressure
[nRows,~] = size(exp2);
...
if import2 == 1
    ...
    toappSWdata = load('APC007_exp2_1000-1200_SW_GasOnly','toapp');
    toappSPKdata = load('APC007_exp2_1000-1200_SPK','toapp');
    excelCONdata = readmatrix('APC007_ContractionClusterList.xlsx');
    SW_AMPs = readmatrix('APC007_SW_AMPs.xlsx');
...
pyl_elec = 15; % Determined in the QuiescentZone script
g_clsts = [50:64];
%i_list = [1:2;5:6;8:9;13:14;16:17;20:21;25:26;28:29;32:33];
%[qz_AVE,qz_SD,pyl_elec] = QuiescentZoneFunc(SWdata,oldElecConfig,g_list,i_list);
%q_metrics = [qz_AVE,qz_SD];
...
%[ap_list,ap_metrics,dp_list,dp_metrics] = Pacemaker(toappSWdata,elecConfig,oldElecConfig,g_list,i_list,qz_AVE);
[PropOut] = Propagation(SWdata,toappSWdata,SPKdata,elecConfig,oldElecConfig,g_clsts,[],25);
