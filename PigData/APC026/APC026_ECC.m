% EndoFLIP data analysis - Electrocontractile Coupling for APC026.
...
% BDF zero: 0s (BDF) / 21582 (flip entry)
% Start time: 640s (BDF) / 27982 (flip entry)
% End time: 760s (BDF) / 29182 (flip entry)

% Extract and save to matrix:
expB = CON_data_m(27982:29182,4:20); % 1-16: Dest, 17: Pressure
[nRows,~] = size(expB);
...
import2 = 1;
if import2 == 1
    addpath 'F:\PigData\APC026'
    toappSWdata = load('APC026_exp2_640-760s_SW_2','toapp');
    toappSPKdata = load('APC026_exp2_640-760s_SPK','toapp');
    excelCONdata = readmatrix('APC026_ContractionClusterList.xlsx');
    SW_AMPs = readmatrix('APC026_SW_AMPs.xlsx'); 
...
g_clsts = 1:10;
i_clsts = [13:15;17:19;20:22;24:26;28:30;31:33;35:37;38:40;42:44;45:47];
